...
export default function TarotLove() {
  return (
    <div>
      <div className="row row-cols-1 row-cols-sm-2 row-cols-lg-4 gy-5 g-lg-5 mt-0">
        <div className="col">
          <div className="card-reda-cm d-inline-block w-100" data-aos="zoom-in">
            <figure>
              <img alt="cr" src="assets/images/lovers.png" />
            </figure>
            <h5 className="text-white mt-3 d-inline-block w-100"> Lovers </h5>
            <p>
              {" "}
              The Loves trong bói Tarot chính xác về tình yêu lại chưa có gì rõ
        ...
        <div className="col">
          <div className="card-reda-cm d-inline-block w-100" data-aos="zoom-in">
            ...
            <p>
              {" "}
              5 of Wands là sự báo hiệu cho một cuộc cạnh tranh khốc liệt. Không
        ...
        <div className="col">
          <div className="card-reda-cm d-inline-block w-100" data-aos="zoom-in">
            ...
            <p>
              {" "}
              Sự xuất hiện của 3 of Cups chứng tỏ thời gian vừa rồi dường như
        ...
        <div className="col">
          <div className="card-reda-cm d-inline-block w-100" data-aos="zoom-in">
            ...
            <p>
              {" "}
              Sự xuất hiện của 3 of Swords cho thấy bạn đang cảm thấy đau khổ và
        ...
        <div className="col">
          <div className="card-reda-cm d-inline-block w-100" data-aos="zoom-in">
            ...
            <p>
              {" "}
              Nếu bạn bốc được 10 of Cups thì xin chúc mừng. Bởi lẽ, đây là quân
        ...
        <div className="col">
          <div className="card-reda-cm d-inline-block w-100" data-aos="zoom-in">
            ...
            <p>
              {" "}
              Công việc mà bạn đang làm lúc này thực sự là công việc mà bạn yêu
        ...
        <div className="col">
          <div className="card-reda-cm d-inline-block w-100" data-aos="zoom-in">
            ...
            <p>
              {" "}
              Bạn đang dành rất nhiều nỗ lực trong công việc để cạnh tranh với
        ...
        <div className="col">
          <div className="card-reda-cm d-inline-block w-100" data-aos="zoom-in">
            ...
            <p>
              {" "}
              Bạn đang nỗ lực chăm chỉ trong công việc với mục tiêu là tạo ấn
        ...
        <div className="col">
          <div className="card-reda-cm d-inline-block w-100" data-aos="zoom-in">
            ...
            <p>
              {" "}
              The Chariot mang Hình ảnh Julius Caesar trên chiếc chiến xa huy
        ...
        <div className="col">
          <div className="card-reda-cm d-inline-block w-100" data-aos="zoom-in">
            ...
            <p>
              {" "}
              8 of Pentacles chúng ta thấy một chàng trai đang đục khắc một đồng
        ...
        <div className="col">
          <div className="card-reda-cm d-inline-block w-100" data-aos="zoom-in">
            ...
            <p>
              {" "}
              Dạng vấn đề tâm lý thông dụng, bao gồm hoảng loạn, lo âu và trầm
        ...
        <div className="col">
          <div className="card-reda-cm d-inline-block w-100" data-aos="zoom-in">
            ...
            <p>
              {" "}
              Lo lâu và trầm cảm ngày càng bị thúc đẩy bởi những lời tự phê phán
        ...
        <div className="col">
          <div className="card-reda-cm d-inline-block w-100" data-aos="zoom-in">
            ...
            <h5 className="text-white mt-3 d-inline-block w-100"> Devil </h5>
            <p>
              {" "}
              Sự nghiện ngập và những thói quen không lành mạnh. Nghiện ngập có
        ...
        <div className="col">
          <div className="card-reda-cm d-inline-block w-100" data-aos="zoom-in">
            ...
            <p>
              {" "}
              Một vấn đề có thể xảy ra bởi sự mất cân bằng hóa học có thể dẫn
        ...
        <div className="col">
          <div className="card-reda-cm d-inline-block w-100" data-aos="zoom-in">
            ...
            <h5 className="text-white mt-3 d-inline-block w-100"> Tower </h5>
            <p>
              {" "}
              Một khủng hoảng lớn hoặc một chuỗi dài hoảng sợ. Nó có thể là kết
        ...
        <div className="col">
          <div className="card-reda-cm d-inline-block w-100" data-aos="zoom-in">
            ...
            <p>
              {" "}
              Mô tả một bàn tay nâng lên cao một đồng xu hình ngôi sao năm cánh.
        ...
        <div className="col">
          <div className="card-reda-cm d-inline-block w-100" data-aos="zoom-in">
            ...
            <p>
              {" "}
              Queen of Pentacles mô tả một người phụ nữ đơn độc ngồi trên ngai
        ...
        <div className="col">
          <div className="card-reda-cm d-inline-block w-100" data-aos="zoom-in">
            ...
            <p>
              {" "}
              Five of Pentacles, như những lá số 5 khác, miêu tả một nghịch
        ...
        <div className="col">
          <div className="card-reda-cm d-inline-block w-100" data-aos="zoom-in">
            ...
            <p>
              {" "}
              Four of Pentacles cho thấy một người đàn ông ngồi trên chiếc ghế,
        ...
        <div className="col">
          <div className="card-reda-cm d-inline-block w-100" data-aos="zoom-in">
            ...
            <p>
              {" "}
              King of Pentacles đại diện cho sự phong phú, an toàn, tham vọng,
