...
const CustomerSchedule = () => {
    ...
    const handleEventClick = (info) => {
        ...
        setSelectedEvent({
            ...
            customerName: event.extendedProps?.customerName || '', // Or fetch from extendedProps if available
        });
        setShowModal(true);
    };
    ...
    return (
        <div>
            <div className="row">
                <h1 className="title">Lịch Xem Tarot</h1>
            </div>
            <div className="row">
            ...
            <Modal show={showModal} onHide={handleCloseModal} centered>
                <Modal.Header closeButton>
                    <Modal.Title>Thông Tin Lịch Đặt</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    {selectedEvent && (
                        <div>
                            <p>
                                <strong>Khác Hàng:</strong> {selectedEvent.customerName}
                            </p>
                            <p>
